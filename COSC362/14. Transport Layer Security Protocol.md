...
$$
ms = \mathrm{PRF}(pms, \textquotedblleft\text{master secret}\textquotedblright, N_C \| N_S)
$$
...
$$
k = \mathrm{PRF}(ms, \textquotedblleft\text{key expansion}\textquotedblright, N_C \| N_S)
$$
