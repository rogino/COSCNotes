...
- Goal -> Intention -> Actions -> Execution
  ...
  - They form an *intention* translate this to the language of the user interface; one or more *actions*
...
- Performance: system acting on the user input (callbacks etc.)
