...
#### 09. Dael with Errors in a Positive and Helpful Manner

Error messages should:

- Use clear language, not codes
- Be precise - rephase user input (e.g. cannot open ${document name} because ${it is not a supported file}
...
- Short intorductory guides and overviews
- Video walkthrough
- Simple task walkthroughs 
