...
- Consider feed-forward: show the effect of the action *before* they commit to it
  - e.g. in Word, on hover over font, update selected text with that font (although this can be distracting)
- Offer choices based on partial task completion (e.g. autocomplete)
