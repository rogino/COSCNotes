...
By removing these things, it separates profitability from the effects of how you are funded (interest rates vary, taxes vary a lot by region etc.) and how you account for your assets (depreciation and amortization varies by company depending on the amount of assets).
...
\text{debt-equity ratio} &= \frac{\text{long-term debt}}{\text{equity}}
...
\text{time interest earned} &= \frac{\text{EBIT}}{\text{interest payments}}
\end{aligned}
$$
...
$$
\begin{aligned}
\text{quick (acid test) ratio} &= \frac{\text{cash} + \text{marketable securities} + \text{receivables}}{\text{current liabilities}} \\
                               &= \frac{\text{current assets} - \text{inventory}                       }{\text{current liabilities}}
\end{aligned}
$$

Note that it is not always possible to quickly convert inventory to cash, especially in unforeseen circumstances.
...
$$
\begin{aligned}
\text{current (working capital) ratio} &= \frac{\text{current assets}}{\text{current liabilities}}
...
\text{net profit margin} &= \frac{\text{net profit after tax}}{\text{net sales}}

\\ \\

\text{return on assets} &= \frac{\text{EBIT}}{\text{total assets}}

\\ \\

\text{return on equity} &= \frac{\text{net profit after tax}}{\text{total equity}}
\end{aligned}
$$
...
- Differs by product and industry; resturants may have a ratio of 300%, infrastructure organizations in the 15-20% range
