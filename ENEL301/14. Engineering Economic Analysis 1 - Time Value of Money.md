...
The payment increases by a constant rate of $g$ each period, and there is an interest rate of $r$ per period. Only valid where $r > g$.
...
Alternatively, you can model it as a standard annuity that you multiply by $1 + r$ (annuity transformation method).
